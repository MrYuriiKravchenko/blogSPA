...
from rest_framework import viewsets, permissions, pagination, generics, request, filters
...
class FeedBackView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer_class.is_valid():
            ...
            send_mail(f'От {name} | {subject}', message, from_email, ['kravchenkoyurii40@gmail.com'])
